...
//Sıfırdan proje (solution) oluşturunuz-->TobetoETrade 
...
//İkinci aşama. Önceki derste (çarşamba) oluşturduğumuz kodlama.io varlıklarını (entity) 
//TobetoCourseAcademy projesine uygulayınız. 
//program.cs de mutlaka veri girişleri yapınız.
